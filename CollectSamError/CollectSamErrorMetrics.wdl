...
task CollectSamErrorMetricsTask {
    ...
    command {
        ...
        MAX_LOCI=1000000 \
        ERROR_METRICS=null \
        ERROR_METRICS="ERROR:READ_ORDINALITY,ERROR:INSERT_LENGTH" \
        ERROR_METRICS="ERROR:READ_ORDINALITY,ERROR:CYCLE" \
        ERROR_METRICS="ERROR:READ_ORDINALITY,ERROR:BASE_QUALITY" \
        ERROR_METRICS="ERROR:READ_ORDINALITY,ERROR:GC_CONTENT" \
        ERROR_METRICS="ERROR:READ_ORDINALITY,ERROR:ONE_BASE_PADDED_CONTEXT" \
