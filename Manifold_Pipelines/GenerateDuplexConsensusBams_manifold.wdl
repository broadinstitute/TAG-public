# checkBaitSetName.compareBaitSetName is inlined at the bottom of this file
# (was: import "../../checkBaitSetName/checkBaitSetName.dev.wdl" as checkBaitSetName).
# Relative imports don't resolve when submitting a standalone WDL to Manifold,
# so the task lives here instead.
...
# ---------------------------------------------------------------------------
# Inlined verbatim from checkBaitSetName/checkBaitSetName.dev.wdl
# (only the standalone `workflow checkBaitSetName {}` wrapper was dropped).
# ---------------------------------------------------------------------------
